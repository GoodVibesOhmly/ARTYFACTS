...
import "https://github.com/GoodVibesOhmly/ARTYFACTS/contracts/ArtyfactsRewards.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";

contract ArtyfactsStaking is Ownable, IERC721Receiver {
 ...
 ArtyfactsRewards token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(ERC721Enumerable _nft, ArtyfactsRewards _token) { 
    nft = _nft;
    token = _token;
  }
